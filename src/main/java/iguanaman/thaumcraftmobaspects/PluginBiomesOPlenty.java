...
public class PluginBiomesOPlenty implements AspectPlugin {
    ...
    public HashSet<ThaumcraftEntity> getThaumcraftMobs() {
        ...
        mobs.add(
                new ThaumcraftEntity(
                        "BiomesOPlenty.Wasp",
                        new AspectList().add(Aspect.BEAST, 1).add(Aspect.FLIGHT, 1).add(Aspect.ORDER, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "BiomesOPlenty.Pixie",
                        new AspectList().add(Aspect.SOUL, 1).add(Aspect.LIGHT, 1).add(Aspect.FLIGHT, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "BiomesOPlenty.Bird",
                        new AspectList().add(Aspect.SENSES, 1).add(Aspect.FLIGHT, 1).add(Aspect.BEAST, 1)));
        mobs.add(
                new ThaumcraftEntity("BiomesOPlenty.Glob", new AspectList().add(Aspect.EARTH, 2).add(Aspect.SLIME, 2)));
        mobs.add(
                new ThaumcraftEntity(
                        "BiomesOPlenty.Phantom",
                        new AspectList().add(Aspect.SOUL, 2).add(Aspect.HUNGER, 1)));
