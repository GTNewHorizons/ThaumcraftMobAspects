...
public class PluginSpecialMobs implements AspectPlugin {
    ...
    public HashSet<ThaumcraftEntity> getThaumcraftMobs() {
        ...
        mobs.add(new ThaumcraftEntity("SpecialMobs.KingGhast", ghastAspects.copy().add(Aspect.SOUL, 1).add(Aspect.FIRE, 1).add(Aspect.MIND, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.MiniGhast", new AspectList().add(Aspect.SOUL, 1).add(Aspect.FIRE, 1).add(Aspect.TRAP, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.QueenGhast", ghastAspects.copy().add(Aspect.SOUL, 1).add(Aspect.FIRE, 1).add(Aspect.LIFE, 1)));
        ...
        mobs.add(new ThaumcraftEntity("SpecialMobs.LemonSlime", slimeAspects.copy().add(Aspect.WEATHER, 1).add(Aspect.TRAVEL, 1)));
        ...
        // OTHER MOBS
        mobs.add(new ThaumcraftEntity("SpecialMobs.LavaMonster", new AspectList().add(Aspect.ELDRITCH, 2).add(Aspect.FIRE, 2)));
