...
public class PluginSpecialMobs implements AspectPlugin {
    ...
    public HashSet<ThaumcraftEntity> getThaumcraftMobs() {
        ...
        mobs.add(new ThaumcraftEntity("SpecialMobs.GravityCreeper", creeperAspects.copy().add(Aspect.TRAP, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        new AspectList().add(Aspect.PLANT, 1).add(Aspect.FIRE, 1)));
        ...
        mobs.add(new ThaumcraftEntity("SpecialMobs.MirageEnderman", endermanAspects.copy().add(Aspect.ENTROPY, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        new AspectList().add(Aspect.SOUL, 1).add(Aspect.FIRE, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        ghastAspects.copy().add(Aspect.SOUL, 1).add(Aspect.FIRE, 1).add(Aspect.MIND, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.MiniGhast",
                        new AspectList().add(Aspect.SOUL, 1).add(Aspect.FIRE, 1).add(Aspect.TRAP, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.QueenGhast",
                        ghastAspects.copy().add(Aspect.SOUL, 1).add(Aspect.FIRE, 1).add(Aspect.LIFE, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        skeletonAspects.copy().add(Aspect.MECHANISM, 1).add(Aspect.MOTION, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.GiantSkeleton",
                        skeletonAspects.copy().add(Aspect.UNDEAD, 3).add(Aspect.MAN, 1).add(Aspect.EARTH, 1)));
        ...
        mobs.add(new ThaumcraftEntity("SpecialMobs.SpitfireSkeleton", skeletonAspects.copy().add(Aspect.FIRE, 2)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        new AspectList().add(Aspect.BEAST, 1).add(Aspect.ENTROPY, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.DesertSpider",
                        spiderAspects.copy().add(Aspect.EARTH, 1).add(Aspect.POISON, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        new AspectList().add(Aspect.BEAST, 4).add(Aspect.ENTROPY, 3)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.HungrySpider", spiderAspects.copy().add(Aspect.HUNGER, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.MotherSpider", spiderAspects.copy().add(Aspect.LIFE, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.SmallSpider",
                        new AspectList().add(Aspect.BEAST, 2).add(Aspect.ENTROPY, 1).add(Aspect.MOTION, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.ToughSpider",
                        spiderAspects.copy().add(Aspect.LIFE, 1).add(Aspect.ARMOR, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.WebSpider", spiderAspects.copy().add(Aspect.TRAP, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.WitchSpider", spiderAspects.copy().add(Aspect.TRAP, 1)));

        // CAVE SPIDERS
        AspectList caveSpiderAspects = new AspectList().add(Aspect.BEAST, 3).add(Aspect.ENTROPY, 2)
                .add(Aspect.POISON, 1);
        mobs.add(new ThaumcraftEntity("SpecialMobs.SpecialCaveSpider", caveSpiderAspects));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.BabyCaveSpider",
                        new AspectList().add(Aspect.BEAST, 2).add(Aspect.ENTROPY, 1).add(Aspect.POISON, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.FlyingCaveSpider", caveSpiderAspects.copy().add(Aspect.FLIGHT, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.MotherCaveSpider", caveSpiderAspects.copy().add(Aspect.LIFE, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.ToughCaveSpider",
                        caveSpiderAspects.copy().add(Aspect.LIFE, 1).add(Aspect.ARMOR, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.WebCaveSpider", caveSpiderAspects.copy().add(Aspect.TRAP, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.WitchCaveSpider", caveSpiderAspects.copy().add(Aspect.TRAP, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        new AspectList().add(Aspect.UNDEAD, 4).add(Aspect.MAN, 2).add(Aspect.EARTH, 2)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        new AspectList().add(Aspect.UNDEAD, 6).add(Aspect.FIRE, 3)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        pigZombieAspects.copy().add(Aspect.HEAL, 1).add(Aspect.HUNGER, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        silverfishAspects.copy().add(Aspect.DARKNESS, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        silverfishAspects.copy().add(Aspect.LIFE, 1).add(Aspect.ARMOR, 1)));
        ...
        mobs.add(new ThaumcraftEntity("SpecialMobs.RageWitch", witchAspects.copy().add(Aspect.ENTROPY, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        witchAspects.copy().add(Aspect.BEAST, 1).add(Aspect.LIFE, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.WindWitch",
                        witchAspects.copy().add(Aspect.MOTION, 1).add(Aspect.SOUL, 1).add(Aspect.TRAVEL, 1)));
        ...
        mobs.add(
                new ThaumcraftEntity(
                        ...
                        new AspectList().add(Aspect.ELDRITCH, 2).add(Aspect.FIRE, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.ConflagrationBlaze", blazeAspects.copy().add(Aspect.FIRE, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.EmberBlaze", blazeAspects.copy().add(Aspect.ENTROPY, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.HellfireBlaze", blazeAspects.copy().add(Aspect.FIRE, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.InfernoBlaze", blazeAspects.copy().add(Aspect.FIRE, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.JoltBlaze",
                        blazeAspects.copy().add(Aspect.WEATHER, 1).add(Aspect.TRAVEL, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.SmolderBlaze", blazeAspects.copy().add(Aspect.DARKNESS, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.WildfireBlaze", blazeAspects.copy().add(Aspect.LIFE, 1)));
        ...
        mobs.add(new ThaumcraftEntity("SpecialMobs.BlackberrySlime", slimeAspects.copy().add(Aspect.ENERGY, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.BlueberrySlime", slimeAspects.copy().add(Aspect.WATER, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.CaramelSlime", slimeAspects.copy().add(Aspect.TRAP, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.GrapeSlime", slimeAspects.copy().add(Aspect.FLIGHT, 1)));
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.LemonSlime",
                        slimeAspects.copy().add(Aspect.WEATHER, 1).add(Aspect.TRAVEL, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.StrawberrySlime", slimeAspects.copy().add(Aspect.FIRE, 1)));
        mobs.add(new ThaumcraftEntity("SpecialMobs.WatermelonSlime", slimeAspects.copy().add(Aspect.MOTION, 1)));

        // OTHER MOBS
        mobs.add(
                new ThaumcraftEntity(
                        "SpecialMobs.LavaMonster",
                        new AspectList().add(Aspect.ELDRITCH, 2).add(Aspect.FIRE, 2)));
